...
//             <Button className="button-custom" href="/register">Register</Button>
//           </div>
//         </div>
...
const Home = () => {
  const teamMembers = [
    { nama: "Ketua Unit", role: "Ketua" },
    { nama: "Wakil Ketua Unit", role: "Wakil Ketua" },
    { nama: "Anggota 1", role: "Anggota" },
    { nama: "Anggota 2", role: "Anggota" },
    { nama: "Anggota 3", role: "Anggota" },
  ];
    ...
    <Layout>
      ...
      <Content>
        <div className="bg">
          ...
          <div className="text-overlay">
            <p className="p">Yuk Selesaikan Praktek <br /> IbTiTah-nya!</p>
            <Button className="button-custom" href="/register" block>
              Register
            </Button>
          </div>
        </div>
      ...
      <Footer style={{ textAlign: "center" }}>
        ©2024 Fakultas Sains dan Teknologi UIN Bandung
      </Footer>
    </Layout>
  );
};
